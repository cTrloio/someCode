...
var SelectScene = (function (_super) {
    ...
    function SelectScene() {
        _super.call(this);
        this.mouseBeginY = 0; //点击时鼠标y坐标
        this.ar = []; //关卡数组
        this.sceneNum = OneScene.maxSceneNum;
    ...
    p.addObject = function () {
        ...
        this.ar[9].y = -70 + 800;
        this.ar[10].x = 160;
        this.ar[10].y = -200 + 800;
        this.ar[11].x = 260;
        this.ar[11].y = -270 + 800;
        this.ar[12].x = 250;
        this.ar[12].y = -370 + 800;
        this.ar[13].x = 160;
        this.ar[13].y = -430 + 800;
        this.ar[14].x = 200;
        this.ar[14].y = -510 + 800;
        this.ar[15].x = 170;
        this.ar[15].y = -600 + 800;
        this.ar[16].x = 70;
        this.ar[16].y = -620 + 800;
        this.ar[17].x = 100;
        this.ar[17].y = -725 + 800;
        this.ar[18].x = 200;
        this.ar[18].y = -740 + 800;
    };
    p.backHd = function () {
        this.mm.playclickM();
