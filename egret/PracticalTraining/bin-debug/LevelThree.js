...
var LevelThree = (function (_super) {
    ...
    var d = __define,c=LevelThree,p=c.prototype;
    ...
    //���������ƶ�����
    p.createRandomNum1 = function (mon) {
    ...
    //����׷�����ҹ���
    p.createRandomNum2 = function (mon) {
    ...
    p.gameOver2 = function () {
        ...
        var src = this;
        document.removeEventListener("keydown", function onKeyDown(event) {
            src.onKeyDOWN(event);
        });
        document.removeEventListener("keyup", function onKeyUp(event) {
            src.onKeyUP(event);
        });
...
egret.registerClass(LevelThree,'LevelThree');
